            					...
            					<input id="basePath" value="${pageContext.request.contextPath}" type="hidden"> 
				      			<input type="hidden" name="page" value="${page}">
				      		 	...
				      		 	<div class="form-group col-md-3" > 
		                         	<input type="text"  name="query" value="${query}" class="form-control col-md-3"  placeholder="对学生姓名进行模糊查询"  >
		                        	</div>
				      		 	<div class="form-group col-md-3" > 
		                      	...
		                      	<c:forEach items="${pageView.records}" var="entry" varStatus="s"> 
			                        <tr>
			                          ...
			                          <td>
			                          	...
			                          	<a href="javascript:edit('${entry.name}')" class="btn btn-primary btn-xs"><i class="fa fa-edit fa-1" aria-hidden="true"></i>修改</a>
			                          	<a href="javascript:del('${entry.name}')" class="btn btn-danger btn-xs"><i class="fa fa-trash fa-1" aria-hidden="true"></i>删除</a>
			                          </td>
			                        </tr>
		                      	</c:forEach>
  ...
  <section class="videocontent" id="video"></section>
	...
	function edit(name) {
		...
		layer.open({
			...
			maxmin : true, // 开启最大化最小化按钮
			area : [ '600px', '400px' ],
			content : basePath + '/stu/edit?name='+name,
